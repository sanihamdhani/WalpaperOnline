...
<form  action="config/upload_post.php" method="POST" enctype="multipart/form-data"
>
          ...
          <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" placeholder="Masukan Nama Gambar" name="nama">
    </div>
    
                
              
               
                <button type="submit" name= "submit" class="btn btn-success bi bi-upload">
